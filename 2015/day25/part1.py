...
def calculate_code(first_code, mul_code, div_code, current_row, current_column):
    #print(current_row, current_column)
    if current_row == rol and current_column == col:
        print(first_code)
        return
    next_code = (first_code * mul_code) % div_code
    if current_row == 1:
        ...
        current_row -= 1
        current_column += 1
    calculate_code(next_code, mul_code, div_code, current_row, current_column)

first_code,mul_code,div_code = 20151125,252533,33554393
rol,col = 2981,3075

calculate_code(first_code, mul_code, div_code,1, 1)
